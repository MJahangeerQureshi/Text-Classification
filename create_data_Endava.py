...
condition=1
while condition:
    print("What is your preferred Input, title or body:")
    Input = input()
    if Input in Inputs:
        condition=0
    else:
        print("Sorry thats not in any of the options")
        pass
    
condition=1
while condition:
    print("What is your preferred Output, ticket_type, category ,sub_category1, sub_category2, business_service, urgency, impact")
    Output = input()
...
InputData = data[Input].tolist()
OutputData = data[Output].tolist()
